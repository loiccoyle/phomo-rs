...
Register-ArgumentCompleter -Native -CommandName 'phomo' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'phomo' {
            ...
            [CompletionResult]::new('-G', '-G ', [CompletionResultType]::ParameterName, 'Compute the distance matrix on the GPU')
            [CompletionResult]::new('--gpu', '--gpu', [CompletionResultType]::ParameterName, 'Compute the distance matrix on the GPU')
            [CompletionResult]::new('--greedy', '--greedy', [CompletionResultType]::ParameterName, 'Use a greedy tile assignment algorithm')
